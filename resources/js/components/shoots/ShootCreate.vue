        ...
        <div class="card-body">
          <form v-on:submit.prevent class="form-horizontal" >
        	...
        	<small>{{errors.description_error}}</small>
				...
				<button @click="submitShoot()" type="submit" class="btn btn-primary">Submit</button>
          </form>
        </div>
    </div>
</div>
...
methods:{
  submitShoot:function(){
    ...
    axios.post(window.location.origin+'/api/shoots',shoot,{headers:headers}).then((response)=>{
