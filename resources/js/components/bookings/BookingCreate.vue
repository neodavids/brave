        ...
        <div class="card-body">
          <form v-on:submit.prevent class="form-horizontal" >
        	...
        	<small>{{errors.facility_error}}</small>
				...
				<button @click="submitBooking()" type="submit" class="btn btn-primary">Submit</button>
          </form>
        </div>
    </div>
</div>
...
methods:{
  submitBooking:function(){
    ...
    axios.post(window.location.origin+'/api/bookings',booking,{headers:headers}).then((response)=>{
