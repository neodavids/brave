        ...
        <div class="card-body">
          <form v-on:submit.prevent class="form-horizontal" >
        	...
        	<small>{{errors.engineers_comment_error}}</small>
				...
				<button @click="submitIssue()" type="submit" class="btn btn-primary">Submit</button>
          </form>
        </div>
    </div>
</div>
...
methods:{
  submitIssue:function(){
    ...
    axios.post(window.location.origin+'/api/issues',issue,{headers:headers}).then((response)=>{
