        ...
        <div class="card-body">
          <form v-on:submit.prevent class="form-horizontal" >
        	...
        	<small>{{errors.head_of_department_error}}</small>
				...
				<button @click="submitDepartment()" type="submit" class="btn btn-primary">Submit</button>
          </form>
        </div>
    </div>
</div>
...
methods:{
  submitDepartment:function(){
    ...
    axios.post(window.location.origin+'/api/departments',department,{headers:headers}).then((response)=>{
